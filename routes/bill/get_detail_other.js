    ...
    handler(request, reply) {
        ...
        request.app.db.query(count_select, (err, countRes) => {
            if(err) {
                ...
                const select = `select d.* from bill b,bill_detail d where b.id=d.bill_id  and ${where} and  d.material_id is null and  b.id=${request.query.id}`;
