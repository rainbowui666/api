    ...
    handler(request, reply) {
        ...
        request.app.db.query(count_select, (err, countRes) => {
            if(err) {
                ...
                const select = `select d.* from bill_detail d where ${where} and  d.material_id is null  and  d.bill_id=${request.query.id} order by d.recommend desc`;
