...
module.exports = {
    path: '/api/cart/update/cart/detail',
    method: 'POST',
    handler(request, reply) {
        const select1 = `set session sql_mode=''`;
        request.app.db.query(select1, (err, res) => {
                                    ...
                                    if(err) {
                                        ...
                                        request.app.db.query(insert, (err, res) => {
                                            if(err) {
                                                ...
                                                const update2 = `update cart set sum=${request.payload.sum} , freight='${request.payload.freight}'  where id=${request.payload.cart_id}`;
