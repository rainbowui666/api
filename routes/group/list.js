    ...
    handler(request, reply) {
        ...
        request.app.db.query(user_url, (err, user_res) => {
            if(err) {
                ...
                where = request.query.province?`${where} and (g.province = '${request.query.province}' or g.province = 'china') `:`${where} `;
                ...
                request.app.db.query(countSql, (err, count_res) => {
                    if(err) {
                        ...
                        where = `${where}  order by status desc,g.activity_code desc,g.id desc `;
