...
module.exports = {
    path: '/api/group/private/list',
    method: 'GET',
    handler(request, reply) {
        let where = request.query.name?` private=1 and g.name LIKE '%${request.query.name}%'`:" private=1 ";
