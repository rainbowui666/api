...
module.exports = {
    ...
    handler(request, reply) {
        ...
        const mapselect = 'select id,code,type,name,tag from material where category=\'hy\' and price>0 and  type in (\'dd\',\'dxsx\',\'dy\',\'hyqt\',\'xxsx\',\'zhy\',\'lty\') order by rand() limit 30';
